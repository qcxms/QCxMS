...
! function for given energy range exc, the number of atoms
! (nuc) and the input parameter ieeatm (av energy/per bond in eV,
! normally 0.5 eV/bond)

  subroutine getieeab(iee_a,iee_b,ieeel,ityp,exc,nuc,ieeatm)
